        ...
        <div className="flex-1 overflow-x-auto">
          <table className="w-full table-fixed border-collapse min-w-[800px]">
            <colgroup>
              ...
              <col className="w-[10%]" /> {/* User ID */}
              <col className="w-[30%]" /> {/* Request DTO */}
              <col className="w-[25%]" /> {/* Arguments */}
              <col className="w-[20%]" /> {/* Timestamp */}
            </colgroup>
            <thead>
              <tr>
                ...
                <th className="px-4 py-3 text-left text-sm font-semibold border-b">Request DTO</th>
